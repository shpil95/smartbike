...
namespace smartbike
{
    public class AzureHelper
    {
        ...
        public static string  blobeConnectionString = "DefaultEndpointsProtocol=https;AccountName=smartbikestorageacc2;AccountKey=hKzX7JJLDMhnL3rpKgUhHjWlNRzPNIO9Vikpunr+dtwz7SgpGLo9FPDQm1ZefUgxHe7/mFEf4e/pPtHJZmnJaA==;EndpointSuffix=core.windows.net";
        ...
        public static async Task performBlobOperation()
        {
            ...
            CloudStorageAccount storageAccount = CloudStorageAccount.Parse(blobeConnectionString);
